...
def automated_compression(oto_graph, model, dummy_input, compressed_model_path, dynamic_axes=False):
    ...
    if dynamic_axes:
        torch.onnx.export(model, 
            ...
            output_names=["output"],
            dynamic_axes={
                # "input.1": {0: "dynamic_batch_size", 2: "dynamic_height", 3: "dynamic_width"},
                "input.1": {0: "dynamic_batch_size"},
    ...
    return onnx_model, compressed_model_path
